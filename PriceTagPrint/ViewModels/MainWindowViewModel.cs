...
namespace PriceTagPrint.ViewModels
{
    ...
    class MainWindowViewModel : ViewModelsBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            this.SelectAutoCommand = new ReactiveCommand<string>().WithSubscribe(x => ShowAutoDisplay(x));
            this.SelectInputCommand = new ReactiveCommand<string>().WithSubscribe(x => ShowInputDisplay(x));

            SubMenuKind.Subscribe(x => MenuKindChanged(x));
        }
        public ReactiveCommand<string> SelectAutoCommand { get; private set; }
        public ReactiveCommand<string> SelectInputCommand { get; private set; }
